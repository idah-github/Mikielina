  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="https://demos.creative-tim.com/soft-ui-dashboard/pages/dashboard.html" target="_blank">
        ...
        <span class="ms-1 font-weight-bold">Mikielena Dashboard</span>
      </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="<?php echo base_url('Admin/Login/logout_user')?>">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <div class="card card-background shadow-none card-background-mask-secondary" id="sidenavCard">
        ...
        <div class="card-body text-start p-3 w-100">
          ...
          <div class="docs-info">
            ...
            <p class="text-xs font-weight-bold">Please check the docs</p>
        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          ...
          <ul class="navbar-nav  justify-content-end">
            <li class="nav-item d-flex align-items-center">
              <a href="<?php echo base_url('Admin/Login')?>" class="nav-link text-body font-weight-bold px-0">
                 <a href="<?php echo base_url('Admin/Login/logout_user')?>">Logout</a>
              </a>
            </li>
        ...
        <div class="col-lg-5 mb-lg-0 mb-4">
          <div class="card z-index-2">
            <div class="card-body p-3">
              ...
              <h6 class="ms-2 mt-4 mb-0"> Active Members </h6>
                ...
                <div class="row">
                  ...
                  <div class="col-3 py-3 ps-0">
                    <div class="d-flex mb-2">
                      ...
                      <p class="text-xs mt-1 mb-0 font-weight-bold">Savings</p>
                    </div>
              ...
              <div class="row">
                <div class="col-lg-6 col-7">
                  ...
                  <p class="text-sm mb-0">
                    ...
                    <span class="font-weight-bold ms-1">taken</span> by members
                  </p>
                </div>
                      ...
                      <td>
                        <div class="d-flex px-2 py-1">
                          ...
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm"><?php echo $loan['FirstName']. ' '; echo $loan['MiddleName']. ' '; echo $loan['FamilyName']?></h6>
                          </div>
                        </div>
                      </td>
              ...
              <div class="timeline timeline-one-side">
                <div class="timeline-block mb-3">
                  ...
                  <div class="timeline-content">
                    <h6 class="text-dark text-sm font-weight-bold mb-0">$2400, Loan taken</h6>
                    <p class="text-secondary font-weight-bold text-xs mt-1 mb-0">22 JAN 7:20 PM</p>
                  </div>
                </div>
                <div class="timeline-block mb-3">
                  <span class="timeline-step">
                  ...
                  <div class="timeline-content">
                    <h6 class="text-dark text-sm font-weight-bold mb-0">New loan payments 453$</h6>
                    <p class="text-secondary font-weight-bold text-xs mt-1 mb-0">31 JAN 11 PM</p>
                  </div>
                </div>
                <div class="timeline-block mb-3">
                  <span class="timeline-step">
                    <i class="ni ni-diamond text-info text-gradient"></i>
                  </span>
                  <div class="timeline-content">
                    <h6 class="text-dark text-sm font-weight-bold mb-0">Savings $5678</h6>
                    <p class="text-secondary font-weight-bold text-xs mt-1 mb-0">21 FEB 11PM</p>
                  </div>
                </div>
                <div class="timeline-block mb-3">
                  <span class="timeline-step">
                    <i class="ni ni-world text-warning text-gradient"></i>
                  </span>
                  <div class="timeline-content">
                    <h6 class="text-dark text-sm font-weight-bold mb-0"> 12 New, Approved Member</h6>
                    <p class="text-secondary font-weight-bold text-xs mt-1 mb-0">20 FEB 2:20 AM</p>
                  </div>
                </div>
                <div class="timeline-block mb-3">
                  <span class="timeline-step">
                    <i class="ni ni-money-coins text-primary text-gradient"></i>
                  </span>
                  <div class="timeline-content">
                    <h6 class="text-dark text-sm font-weight-bold mb-0"> $677 Total interest from Loans</h6>
                ...
                <div class="timeline-block">
                  ...
                  <div class="timeline-content">
                    <h6 class="text-dark text-sm font-weight-bold mb-0">2 New member  and 3 loan application </h6>
                    <p class="text-secondary font-weight-bold text-xs mt-1 mb-0">27 FEB</p>
                  </div>
                </div>
              </div>
            </div>
