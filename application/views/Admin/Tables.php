  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link  active" href="<?php echo base_url('Admin/Tables')?>">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <h6 class="font-weight-bolder mb-0"><Table></Table></h6>
        </nav>
                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">DateJoined</th>
                      ...
                      <td>
                        <div class="d-flex px-2 py-1">
                          ...
                          <div class="d-flex flex-column justify-content-center">
                            ...
                            <p class="text-xs text-secondary mb-0">guantai@gmail.com</p>
                          </div>
                        </div>
                      </td>
                      <td>
                        <p class="text-xs font-weight-bold mb-0">ChairMan</p>
                        <p class="text-xs text-secondary mb-0">Mikielina</p>
                      </td>
                      ...
                      <td>
                        <div class="d-flex px-2 py-1">
                          ...
                          <div class="d-flex flex-column justify-content-center">
                            ...
                            <p class="text-xs text-secondary mb-0">alice@gmail.com</p>
                          </div>
                        </div>
                      </td>
                      <td>
                        <p class="text-xs font-weight-bold mb-0">Assistant Chair</p>
                        <p class="text-xs text-secondary mb-0">Mikielina</p>
                      </td>
                      <td class="align-middle text-center text-sm">
                      ...
                      <td>
                        <div class="d-flex px-2 py-1">
                          ...
                          <div class="d-flex flex-column justify-content-center">
                            ...
                            <p class="text-xs text-secondary mb-0">lenah@gmail.com</p>
                          </div>
                        </div>
                      </td>
                      <td>
                        <p class="text-xs font-weight-bold mb-0">Treasurer</p>
                        <p class="text-xs text-secondary mb-0">Mikielina</p>
                      </td>
                      <td class="align-middle text-center text-sm">
                      ...
                      <td>
                        <div class="d-flex px-2 py-1">
                          ...
                          <div class="d-flex flex-column justify-content-center">
                            ...
                            <p class="text-xs text-secondary mb-0">guantaiidah@gmail.com</p>
                          </div>
                        </div>
                      </td>
                      <td>
                        <p class="text-xs font-weight-bold mb-0">Secretary</p>
                        <p class="text-xs text-secondary mb-0">Mikielina</p>
                      </td>
                      <td class="align-middle text-center text-sm">
                        <span class="badge badge-sm bg-gradient-success">Online</span>
                      ...
                      <td>
                        <div class="d-flex px-2 py-1">
                          ...
                          <div class="d-flex flex-column justify-content-center">
                            ...
                            <p class="text-xs text-secondary mb-0">muthoni@gmail.com</p>
                          </div>
                        </div>
                      </td>
                      <td>
                      ...
                      <td>
                        <div class="d-flex px-2 py-1">
                          ...
                          <div class="d-flex flex-column justify-content-center">
                            ...
                            <p class="text-xs text-secondary mb-0">natalia@gmail.com</p>
                          </div>
                        </div>
                      </td>
                      <td>
                ...
                <table class="table align-items-center justify-content-center mb-0">
                  ...
                  <tbody>
                    <tr>
                      <td>
                        <div class="d-flex px-2">
                          ...
                          <div class="my-auto">
                            <h6 class="mb-0 text-sm">Savings</h6>
                          </div>
                        </div>
                      </td>
                      <td>
                      ...
                      <td>
                        <span class="text-xs font-weight-bold">ongoing</span>
                      </td>
                      <td class="align-middle text-center">
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2">
                          ...
                          <div class="my-auto">
                            <h6 class="mb-0 text-sm">Loans</h6>
                          </div>
                        </div>
                      </td>
                      <td>
                      ...
                      <td class="align-middle text-center">
                        <div class="d-flex align-items-center justify-content-center">
                          ...
                          <div>
                            <div class="progress">
                              <div class="progress-bar bg-gradient-success" role="progressbar" aria-valuenow="70" aria-valuemin="0" aria-valuemax="700" style="width: 70%;"></div>
                            </div>
                          </div>
                        </div>
                      </td>
                    ...
                    <tr>
                      ...
                      <td>
                        <p class="text-sm font-weight-bold mb-0">$5,400</p>
                      </td>
                      <td>
                        <span class="text-xs font-weight-bold">ongoing</span>
                      </td>
                      <td class="align-middle text-center">
                        <div class="d-flex align-items-center justify-content-center">
                          ...
                          <div>
                            <div class="progress">
                              <div class="progress-bar bg-gradient-danger" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="50" style="width: 50%;"></div>
                            </div>
                          </div>
                        </div>
                      </td>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2">
                          ...
                          <div class="my-auto">
                            <h6 class="mb-0 text-sm">Fines</h6>
                          </div>
                        </div>
                      </td>
                      <td>
                      ...
                      <td class="align-middle text-center">
                        <div class="d-flex align-items-center justify-content-center">
                          ...
                          <div>
                            <div class="progress">
                              <div class="progress-bar bg-gradient-success" role="progressbar" aria-valuenow="0" aria-valuemin="100" aria-valuemax="100" style="width: 100%;"></div>
                            </div>
                          </div>
                        </div>
                      </td>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2">
                          ...
                          <div class="my-auto">
                            <h6 class="mb-0 text-sm">Dividends</h6>
                          </div>
                        </div>
                      </td>
                      <td>
                      ...
                      <td>
                        <span class="text-xs font-weight-bold">onhold</span>
                      </td>
                      <td class="align-middle text-center">
                        <div class="d-flex align-items-center justify-content-center">
                          ...
                          <div>
                            <div class="progress">
                              <div class="progress-bar bg-gradient-info" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="0" style="width: 0%;"></div>
                            </div>
                          </div>
                        </div>
                      </td>
